      ...
      <div>
        ...
        {this.state.package === 0 ? (
          <div className="item-content-card">
            <GameDetailSearchBar game={this.props.game} onChange={this.onChange.bind(this)} onViewPackage={this.onViewPackage.bind(this)} />
          </div>
        ) : (
          <PackageDetail package={this.state.packageView} onChange={this.onChange.bind(this)} onReturn={this.onReturn.bind(this)} />
        )}
