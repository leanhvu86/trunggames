...
class GameDetailSearchBar extends React.Component {
  ...
  componentDidMount() {
    if (this.props.game.gamePackages) this.setState({ packages: this.props.game.gamePackages });
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
            ...
            <div className="col">
              <div className="row">
                <div className="col" style={{ textAlign: 'center' }}>
                  ...
                  <span>
                    <FormattedMessage id="Kho" />: {item.warehouseQuantity}&nbsp;&nbsp; <FormattedMessage id="Số lượng đã bán" />:
                    {item.tradeCount}
                  </span>
                </div>
                <div className="col">
          ...
          <div className="row">
            <div className="col">
              <div className="child-search-content">
                ...
                <br />
                <input type="text" className="search-input " id="addEventstart" required name="startDate" placeholder="Type a package" />
              </div>
            </div>
            <div className="col">
              <div className="child-search-content">
