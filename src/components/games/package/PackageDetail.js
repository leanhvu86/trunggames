...
class PackageDetail extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            imageId: props.package[0].imageId,
        ...
        return (
            <div className="row">
                <div className="col-4" style={{textAlign: 'center'}}>
                    ...
                    <StarsRating style={{color: '#ff8000'}}
                                 value={this.state.package.rating}
                                 disabled={true}/>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <p><b className="currency">
                                <CurrencyFormat displayType={'text'} value={this.state.package.price}
                                                thousandSeparator={true}
                                                prefix={this.props.currency}/> </b>
                                &nbsp;/&nbsp;
                        ...
                        <div className="col">
                            ...
                            <br/>{this.state.package.attribute}
