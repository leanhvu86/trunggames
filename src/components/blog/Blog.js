...
const blogs = [
    {
        ...
        author: "admin",
        postDate: "21/07/2022",
        contentEn: "LMHT Pantheon sắp được Riot hồi sinh thành \"Thần Rừng\" ở phiên bản 12.14 dự kiến sẽ được ra mắt vào ngày 27/7 tới.\n" +
        ...
        contentVi: "LMHT Pantheon sắp được Riot hồi sinh thành \"Thần Rừng\" ở phiên bản 12.14 dự kiến sẽ được ra mắt vào ngày 27/7 tới.\n" +
            "Nếu các bạn còn nhớ thì vào thời điểm mới được làm lại, Pantheon là một trong những tướng mạnh nhất LMHT và có tỷ lệ cấm chọn 100% tại CKTG 2019. Kể cả khi sang tới CKTG 2020 một năm sau đó thì Pantheon vẫn là một tướng mạnh, đa dụng và có thể chơi được nhiều vị trí từ Đường Giữa, Đi Rừng cho tới Hỗ Trợ."
    },
    {
        id: 2,
...
class Blog extends React.Component {
    ...
    renderDetail() {
        return (
            <div className="container">
                <div className="row">
                    <div className={window.innerWidth < 1000 ? 'container' : "col-8"}>
