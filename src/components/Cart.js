...
import { addQuantity, deselect, deselectAll, removeItem, select, selectAll, subtractQuantity } from '../constants/cartActions';
          ...
          if (json.status === 200) {
            ...
            toast.warn(
              this.props.language === 'en'
                ? 'Create order fail, please contact with admin!'
                : 'Đặt hàng thất bại, vui lòng liên hệ với admin!'
            );
          }
          this.props.deselectAll(1);
          this.scanCheckoutInfo();
  ...
  render() {
              ...
              <div className="col">
                <div className="row">
                  <div className="col-3" style={{ display: 'flex' }}>
                    <input type="checkbox" checked={item.checkout} onChange={() => this.handleCheckout(this, item.packageId)} />
    ...
    return (
      <div>
        ...
        <NavBar />
        <h3 style={{ color: 'white', paddingLeft: '10%' }}>
        ...
        <div className="container pack-content">
          ...
          <div className="row " style={{ fontWeight: 'bolder' }}>
            <div className="col">
              <input type="checkbox" onChange={() => this.handleCheckoutAll(this)} checked={this.props.checkoutAll} /> &nbsp;&nbsp;
              <FormattedMessage id="select_all" />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span>
                {this.state.selected}&nbsp;&nbsp;
                <FormattedMessage id="item_selected" />
              </span>
            </div>
            <div className="col">
              <button className="btn btn-primary float-right" onClick={() => this.onCheckout(this)} disabled={this.state.selected <= 0}>
              ...
              <div className="float-right" style={{ fontSize: '20px', paddingRight: '10px' }}>
                <p>
                  ...
                  <b className="currency">
                    <CurrencyFormat displayType={'text'} value={this.state.total} thousandSeparator={true} prefix={this.props.currency} />
                  </b>
                </p>
              </div>
            </div>
