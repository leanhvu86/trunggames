        ...
        >
          <div>
            <div className="row w-100 m-0 align-items-center justify-content-center mb-4">
              <div style={{ width: '100px' }}>
                <Link to="/">
                  <img src={require('./service-image/first_logo-removebg-preview.png')} style={{ width: '100%', height: 'auto' }} alt="" />
                </Link>
              </div>
            </div>
          ...
          <form className="needs-validation mt-4" onSubmit={this.handleSubmit}>
            ...
            <div className="mt-3">
              ...
              >
                {this.state.loginForm ? <FormattedMessage id="sign_up" /> : <FormattedMessage id="sign_in" />}
              </a>
            </div>
          </form>
        </div>
